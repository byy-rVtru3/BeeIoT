...
import com.app.mobile.presentation.ui.screens.confirmation.viewmodel.ConfirmationEvent
...
fun ConfirmationScreen(
	...
	when (val state = confirmationUiState.value) {
		...
		is ConfirmationUiState.Error   -> ErrorMessage(message = state.message, confirmationViewModel::resetError)
